...
const webhookUrl =
  "https://discord.com/api/webhooks/1392958938202509533/od45JrAsjmCFizz_5Vv_QaZVJixQG7JHn7iUYuzsWgMga37y1ILfhjhZAlfJpwGAiUdR"; // Asegúrate de que este sea tu webhook real
...
HaxballJS.then((HBInit) => {
  const room = HBInit({
    roomName: "🔵⚪ FUTSAL JUEGAN TODOS HAXARG 🏆🧉",
    maxPlayers: 16,
    public: true,
    noPlayer: false,
