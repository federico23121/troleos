...
const token = "thr1.AAAAAGhwMHGmwK5CbIU9hg.k7qQ8ChgB8M";
const webhookUrl =
  "https://discord.com/api/webhooks/1392980912018297023/dqNv5-dtwcHdkHA3u3OxlfbHC5lekgzTcwSewLplLlZgCJBGejxt7eUYINz-FPcNry8d"; // Asegúrate de que este sea tu webhook real
...
HaxballJS.then((HBInit) => {
  const room = HBInit({
    roomName: "🔴⚪ Gana sigue: Stefano365P en YT ⚪🔴",
    maxPlayers: 16,
    public: true,
    noPlayer: false,
    playerName: "son idiotas",
    token: token,
    geo: {
  ...
  room.onPlayerJoin = function (player) {
    ...
    room.sendAnnouncement(`Arg.Becken ip: 190.138.109.181`, null,0xFf0000,"bold",2);
