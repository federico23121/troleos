...
const BOT_NICKNAME = "Arg.Becken" + process.env.JOB_ID || "bot";
...
async function main() {
    ...
    try {
        ...
        await sendMessageToChat(frame, "Vamos a atacar la ip de cada jugador que se haya metido a nuestros host falso de hax arg");
